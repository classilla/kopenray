...
public class VncViewer extends java.applet.Applet implements
	...
	public VncViewer(ThinClient displayClient, String[] argv) {
		this.mainArgs = argv;
	...
	protected void createCanvas(int maxWidth, int maxHeight) throws IOException {
		vc = new VncCanvas(displayClient, this, maxWidth, maxHeight);
	}
	...
	void connectAndAuthenticate() throws Exception {
		...
		if (inSeparateFrame) {
			vncFrame.pack();
			vncFrame.setVisible(true); // vncFrame.show();
		} else {
			validate();
		}
...
// Deprecated. This needs to be reworked when we figure out how a thread
// should quit out.
	...
	public void windowClosing(WindowEvent evt) {
		...
		vncContainer.setVisible(false); // vncContainer.hide();
